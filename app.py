...
def type_error():
    ...
    try:
        return str(int(num1) + int(num2)), 200
    except ValueError:
        return "Error: Both num1 and num2 must be numeric", 400
    except TypeError:
        return "Error: Both num1 and num2 must be numeric or able to convert to integer", 400
    except Exception as e:
        return str(e), 500
